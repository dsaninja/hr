...
/**
 * when you look to sample input and sample output and the difference between budget
 * spent and left u will figure out that senior must have 100 as budget limit and
 * junior must have 50.
 */
class FamilyMember{
